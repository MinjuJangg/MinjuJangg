...
- [FGVC FathomNet Classification](https://github.com/MinjuJangg/FGVC-Fathomnet-classification) - Fine-grained marine species classification model using environmental context
- [Table Recognition](https://github.com/MinjuJangg/Table_recognition) - Korean table recognition project combining UniTable with OCR engines
- [Intent Analysis](https://github.com/MinjuJangg/intent_analysis) - Korean intent classification and slot filling model
- [Threat Priority Estimation](https://github.com/MinjuJangg/priority_threat) - Object-detection-based threat priority estimation algorithm for unmanned tanks
- [Text2Image Shinhan](https://github.com/MinjuJangg/Text2Image_shinhan) - Korean prompt-based image generation and background removal pipeline
- [FederatedLearning-Robot](https://github.com/MinjuJangg/FederatedLearning-Robot) - Federated-learning-based robot control project for production automation
